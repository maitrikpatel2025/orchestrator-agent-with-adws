...
Create a new plan to resolve the `Chore` using the exact specified markdown `Plan Format`. Follow the `Instructions` to create the plan. Follow the `Report` section to properly report the results of your work.
